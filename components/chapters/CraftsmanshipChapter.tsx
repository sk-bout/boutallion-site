...
export default function CraftsmanshipChapter() {
        ...
        <div className="space-y-16 md:space-y-24">
          ...
          >
            <p className="font-refined text-lg md:text-xl text-white/80 leading-relaxed max-w-2xl">
              Hands that measure, cut, and stitch with precision. Each garment
              is a dialogue between maker and material.
            </p>
          </div>
            ...
            {[1, 2, 3].map((item, index) => (
              <div
                ...
                style={{
                  opacity: isVisible ? 1 : 0,
                  transform: isVisible ? 'scale(1)' : 'scale(0.98)',
                  transition: `opacity 1600ms ease-in-out ${600 + index * 200}ms, transform 1600ms ease-in-out ${600 + index * 200}ms`,
                }}
              >
                <div className="absolute inset-0 bg-white/5" />
                <div className="absolute inset-0 flex items-center justify-center text-white/20 font-refined text-sm">
                  Craftsmanship Detail {item}
                </div>
              </div>
            ))}
          </div>
          ...
          <div
            ...
            style={{
              opacity: isVisible ? 1 : 0,
              transform: isVisible ? 'translateY(0)' : 'translateY(20px)',
              transition: 'opacity 1200ms ease-in-out 1200ms, transform 1200ms ease-in-out 1200ms',
            }}
          >
            <p className="font-refined text-lg md:text-xl text-white/80 leading-relaxed max-w-2xl">
              The work is quiet, sacred, documentary. No explanations needed.
            </p>
          </div>
        </div>
      </div>
