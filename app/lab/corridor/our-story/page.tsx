        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            <p className="font-refined text-lg text-white/80 leading-relaxed">
              Our story begins where tradition meets aspiration. This page will share the journey
              of Boutallion—the moments, the vision, and the dedication that define us.
            </p>
            <Link
